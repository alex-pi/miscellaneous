...
def archivoCarga = new FileInputStream(new File('/home/pi/Dropbox/GM3Work/reycosa/layout_reycosa_prueba.csv'))
...
def datos = tokensArchivo.collect { row -> 
    ...
    def mapaDatos = [
		...
		idServicioBase: getIdArticulo(row[7]),
        ...
        idUltServicioAlmacenaje: row[14] != NULL? getIdArticulo(row[14]):row[14],
        nomCortoUltServicioAlmacenaje: row[14],
        fechaEntrada: row[15],
...
${e.totalEmpaques},${e.valorMercadoKilo},'MIGRADA',${e.idUltServicioAlmacenaje},NULL,
...
${e.idServicioCargado},${e.pesoBruto},${e.totalEmpaques},NULL,'ACTIVO',0,
